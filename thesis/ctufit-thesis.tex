...
\include{text/magneticka_rezonancia}

\include{text/analyza_sucasnej_aplikacie}

\include{text/analyza_a_navrh_webovej_aplikacie}

\include{text/implementacia}

\include{text/testovanie}

\include {text/zhodnotenie}
