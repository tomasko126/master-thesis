...
\abstractCS{Cieľom tejto diplomovej práce je vytvoriť webovú aplikáciu, ktorej úlohou bude analyzovať pohyb myokardu z DICOM snímiek magnetickej rezonancie.
...
Nakoľko je pre plné využitie implementovanej aplikácie nutné doimplementovať potrebnú funkcionalitu, boli pre autorov pokračujúcich vo vývoji tejto aplikácie zanechané odporúčania týkajúce sa následného vývoja tejto aplikácie.
}
...
As it is necessary to implement the necessary functionality for the full use of the implemented application, recommendations regarding the subsequent development of this application were left for the authors continuing the development of this application.
\clearpage
}
\placeForDeclarationOfAuthenticity{V~Prahe}
\declarationOfAuthenticityOption{4} 
\keywordsCS{API, analýza myokardu, Cornerstone, DICOM, magnetická rezonancia, Nuxt.js, SPAMM, TypeScript, WebAssembly, webová aplikácia}
\keywordsEN{API, myocardial analysis, Cornerstone, DICOM, magnetic resonance, Nuxt.js, SPAMM, TypeScript, WebAssembly, web application}