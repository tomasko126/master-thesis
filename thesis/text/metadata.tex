...
\keywordsCS{API, analýza myokardu, Cornerstone, DICOM, magnetická rezonancia, SPAMM}
\keywordsEN{API, myocardial analysis, Cornerstone, DICOM, magnetic resonance, SPAMM}